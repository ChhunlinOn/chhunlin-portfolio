...
export default function Home() {
  ...
  return (
    ...
    <div id="container-home" className="block">
      <div id="Profile">
        <Image src="/profilecopy.jpg" alt=""  width={150} height={150}/>
      </div>
      <div id="intro">
  ...
  <div className="slider-wrapper">
    ...
    >
      {cards.map((card) => (
        ...
        <Image src={card.image} alt={card.title} className="user-image" width={150} height={150}/>
...
<div id="container-experience" className="experience-container">
      ...
      <div className="skills-items">
        <div className="skill-item blue-box-shadow">
          <Image src="/Notion-Logo.png" alt="JavaScript" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow">
          <Image src="/postman-icon.png" alt="CSS" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item blue-box-shadow">
          <Image src="/MySQL-Logo.wine.png" alt="Python" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow">
          <Image src="/pgadmin-4-logo.png" alt="JavaScript" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item blue-box-shadow">
          <Image src="/React.webp" alt="CSS" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow bg-white">
          <Image src="/nextjs-icon-1024x1024-5et230l7.png" alt="Python" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item blue-box-shadow">
          <Image src="/d8d635fbfcd76e2314ebb60e437d4839.png" alt="JavaScript" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow">
          <Image src="/HTML5_Badge_512.png" alt="CSS" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item blue-box-shadow">
          <Image src="/javascript-logo-javascript-icon-transparent-free-png.webp" alt="Python" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow">
          <Image src="/GitHub-Logo.svg" alt="JavaScript" className="skill-image bg-white" width={100} height={100} />
        </div>
        <div className="skill-item blue-box-shadow">
          <Image src="/Tailwind_CSS_Logo.svg.png" alt="CSS" className="skill-image" width={100} height={100} />
        </div>
        <div className="skill-item red-box-shadow">
          <Image src="/pngwing.com.png" alt="Python" className="skill-image" width={100} height={100} />
        </div>
      </div>
    </div>
